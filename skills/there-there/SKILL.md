...
- **Inline images**: Customer-pasted screenshots come back on each message under `inline_images[]`. Save one with `there-there download-attachment --media=ULID > screenshot.png`; see [references/commands.md](references/commands.md#download-attachment).
